                ...
                <div class="modal-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="penerbit" class="form-control modern-input" value="{{ $buku->penerbit }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="tahun_terbit" class="form-control modern-input" value="{{ $buku->tahun_terbit }}">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input  type="date" name="tanggal_masuk" class="form-control modern-input" value="{{ \Carbon\Carbon::parse($buku->tanggal_masuk)->format('Y-m-d') }}">
                        </div>

                        <!-- Sumber -->
                        <div class="col-md-6 ">
                            <label class="modern-label"> Sumber Buku </label>
                            <input type="text"   name="sumber" class="form-control modern-input"  value="{{ $buku->sumber }}">
                        </div>

                        <!-- Jilid -->
                        <div class="col-md-4 ">
                            <label class="modern-label"> Jilid
                                <small class="text-danger">
                                    (Opsional)
                                </small>
                            </label>

                            <input type="text" name="jilid" class="form-control modern-input" value="{{ $buku->jilid }}">
                        </div>
                        ...
                        <div class="col-md-4  ">
                            ...
                            <input  type="text"  name="edisi" class="form-control modern-input"  value="{{ $buku->edisi }}">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            @endif
                            <input type="file" name="cover" class="form-control modern-input">
                        </div>
                        <div class="col-12">
                            <label class="modern-label"> Keterangan
                                <span class="optional">(Opsional)</span>
                            </label>
                            <textarea class="form-control modern-textarea" rows="4" name="keterangan">{{ $buku->keterangan }}</textarea>
                        </div>
                    </div>
                </div>
